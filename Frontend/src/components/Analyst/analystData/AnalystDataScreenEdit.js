          ...
          <Col md="auto" className="col-edit">
            ...
            <Row md="">
              <Form.Group className="mb-3">
                ...
                <Form.Control size="lg" defaultValue={user.first_name} name ='first_name'  />
              </Form.Group>
              <Form.Group className="mb-3">
                <Form.Label>Sobrenome</Form.Label>
                <Form.Control size="lg" defaultValue= {user.last_name} name ='last_name'  />
              </Form.Group>
              <Form.Group className="mb-3">
                <Form.Label>Nome de usuario</Form.Label>
                <Form.Control size="lg" defaultValue={user.username} name ='username' />
              </Form.Group>
              <Form.Group className="mb-3">
                <Form.Label>CPF</Form.Label>
                <Form.Control size="lg" defaultValue={analyst.cpf} name ='cpf' />
              </Form.Group>
              <Form.Group className="mb-3">
                <Form.Label>E-email</Form.Label>
                <Form.Control size="lg" defaultValue={user.email} name = 'email' />
              </Form.Group>
              <Form.Group className="mb-3">
                <Form.Label>Especialidade</Form.Label>
                <Form.Control size="lg" defaultValue={analyst.specialty} name ='specialty' />
              </Form.Group>
              <Row class="row align-items-center">
                <Col md="auto">
                <div >
            
              <input className="contact-btn" type="submit" defaultValue="Atualizar Dados" />
